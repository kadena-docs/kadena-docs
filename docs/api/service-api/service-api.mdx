...
For more information about Pact endpoints, see the [Pact REST API](/api/pact-api) or the [Pact OpenAPI](https://api.chainweb.com/openapi/pact.html) specification.
