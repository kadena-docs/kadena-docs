...
By installing and running `chainweb-node` and connecting to the Kadena test or production network, you can extend the peer-to-peer communication infrastructure and have direct access to the blockchain state.
