               ...
               items: [
                    ...
                    },
                    {
                         ...
                         items: [
                              ...
                              'pact-5/repl/env-milligas',
                              'pact-5/repl/env-module-admin',
                              'pact-5/repl/env-namespace-policy',
                              'pact-5/repl/env-set-debug-flag',
                              'pact-5/repl/env-set-milligas',
                              'pact-5/repl/env-sigs',
                              'pact-5/repl/env-verifiers',
                              'pact-5/repl/expect-failure',
                              'pact-5/repl/expect-that',
                              'pact-5/repl/expect',
                              'pact-5/repl/load',
                              'pact-5/repl/pact-state',
                              'pact-5/repl/print',
